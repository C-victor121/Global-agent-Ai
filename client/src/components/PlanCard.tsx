...
import { Plan } from '@/services/plan.service'; // Asegúrate que la ruta a Plan es correcta

export const PlanCard: React.FC<{ plan: Plan; isAdmin?: boolean; onEdit?: (plan: Plan) => void; onDelete?: (planId: string) => void; }> = ({ plan, isAdmin = false, onEdit, onDelete }) => {
