...
"[project]/client/.next-internal/server/app/api/auth/[...nextauth]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/client/src/app/api/auth/[...nextauth]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
    ...
    callbacks: {
        ...
        async jwt ({ token, user, account, profile, trigger }) {
            ...
            if (user) {
                console.log('!!! JWT callback - Usuario presente (signIn o OAuth)', {
                    user
                });
                token.id = user.id;
            ...
            console.log('!!! JWT callback - FIN, token a retornar:', {
                ...token
            });
            return token;
        },
        async session ({ session, token }) {
            console.log('!!! Session callback - INICIO', {
                session: {
                    ...session
                },
                token: {
            ...
            if (session?.user) {
                ...
                session.user.role = token.role || 'user'; // Default a 'user' si no está
                session.user.image = token.picture || session.user.image; // Mantener imagen si existe
            }
            console.log('!!! Session callback - FIN, sesión a retornar:', {
                ...session
            });
            return session;
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab4a1a2c._.js.map